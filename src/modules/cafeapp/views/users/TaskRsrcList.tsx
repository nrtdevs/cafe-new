...
import { TaskRSRCList, UserData } from '@src/utility/types/typeAuthApi'
...
const TaskList = (props: any) => {
    ...
    // load users
    const [loadUsers, loadUserResponse] = useTaskRsrcListMutation()
    // delete mutation
    ...
    const renderViewModal = () => {
        return (
            <CenteredModal
                open={modalView}
                title={state.selectedUser?.acct_id}
                done='edit'
                hideClose
                disableFooter
            ...
            <Col md='8'>
              ...
              <p className='text-muted small mb-0'>{FM('edit-description')}</p>
                    ...
                    <Row>
                        <Col md='6'>
                            <Label className='text-uppercase mb-25'>CCT ID</Label>
                            <p className='text-dark fw-bold text-capitalize'>
                                {state.selectedUser?.acct_id}
                                <span className='text-dark fw-bold text-capitalize small ms-50'>
                                    <span className={'text-danger'}>{state.selectedUser?.task_status_code}</span>
                                </span>
                            </p>
                        </Col>
                        <Col md='6'>
                        ...
                        <Col md='6'>
                            <Label className='text-uppercase mb-25'>RSRC Type</Label>
                            <p className='text-dark fw-bold text-capitalize'>
                                {state.selectedUser?.rsrc_type ?? 'N/A'}
                            </p>
                        </Col>
                        <Col md='6'>
                            <Label className='text-uppercase mb-25'>RSRC ID List</Label>
                            <p className='text-dark fw-bold text-capitalize'>
                                {state.selectedUser?.rsrc_id ?? 'N/A'}
                            </p>
                        </Col>
                        <Col md='6'>
    ...
    // table columns
    const columns: TableColumn<TaskRSRCList>[] = [
        {
            name: 'CCT Id',
            sortable: true,
            id: 'name',
        ...
        },
        {
            ...
            sortable: true,
            id: 'email',
            cell: (row) => <Fragment>{row?.rsrc_id}</Fragment>
        },
        {
            name: 'Task Id',
            sortable: true,
        ...
        },
        {
            ...
            sortable: true,
            id: 'mobile_number',
            cell: (row) => <Fragment>{row?.rsrc_type}</Fragment>
        },
        {
            name: 'Start Date',
            sortable: true,
