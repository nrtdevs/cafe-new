...
const WeekWiseCafeSales = (props: any) => {
  const date = new Date()
  ...
  const [loadWhatsApp, loadResp] = useWeeklyCafeReportMutation()
  ...
  return (
    <Fragment>
      ...
      <Header route={props?.route} icon={<Menu size='25' />} title={FM('week-wise-cafe-sales')}>
        <ButtonGroup color='dark'>
          <WeeklyMenusWiseFilter handleFilterData={handleFilterData} type='cafe' />
          <LoadingButton
            tooltip={FM('reload')}
...
export default WeekWiseCafeSales
