...
import { salaryResponseTypes } from '@src/modules/cafeapp/redux/RTKFiles/ResponseTypes'
...
const EmployeeSalaryFilter: FC<FilterProps> = (props) => {
    // toggle modal
    const [modal, toggleModal] = useModal()

    // form hook
    const form = useForm<salaryResponseTypes>({
        defaultValues
    })
    ...
    return (
        <Fragment>
            ...
            <SideModal
                ...
                title={FM('filter-employee-salary')}
                done='filter'
            >
                <Row>
