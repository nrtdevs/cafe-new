...
import { useCreateOrUpdateRoleMutation, useLoadPermissionsMutation } from '@src/modules/cafeapp/redux/RTKFiles/cafe/RoleRTK'
    ...
    useEffect(() => {
        if (!loadPermissionsResponse.isUninitialized) {
            if (loadPermissionsResponse.isSuccess) {
                setState({
                    permissions: loadPermissionsResponse.data?.payload
                })
            ...
            >
                <div className='p-1' style={{ minHeight: '60vh' }}>
                    <Form onSubmit={form.handleSubmit(handleSave)}>
                        ...
                        <Row className='justify-content-start border-bottom border-top pb-1'>
