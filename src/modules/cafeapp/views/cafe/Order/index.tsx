                ...
                <div className='row'>
                  <div className='col-xl-8'>
                    <ul className='list-unstyled'>
                      ...
                      <li className='text-muted'>
                        <span className=''>{FM('customer-contact')} : </span>
                        <span className=''>{state?.selectedUser?.contact_number}</span>
                      </li>
                    </ul>
                  </div>
                  <div className='col-xl-4'>
                    <ul className='list-unstyled'>
                      ...
                      <li className=''>
                        <i className='fas fa-circle' style={{ color: '#84B0CA' }}></i>{' '}
                        <span className='fw-bold'>{FM('employee')} : </span>
                        {state.selectedUser?.employee?.name}
                      </li>
                    </ul>
                  </div>
                </div>
