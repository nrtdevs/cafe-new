...
const defaultValues: any = {
  warehouse_id:'',
    ...
    transfer_recieved_id:''
}

const QuantityMismatchFilter: FC<FilterProps> = (props) => {
    // toggle modal
                    ...
                    <Show IF={userData?.role_id===7}>
                      ...
                      {/* <Col md='12'>
                        <FormGroupCustom
                            ...
                            control={form.control}
                            async
                            label='transfer Recirved'
                            name='transfer_recieved_id'
                            isClearable
                            loadOptions={loadDropdown}
                            path={ApiEndpoints.listItemTransfers}
                            selectLabel={(e) => `${e.date}  `}
                            selectValue={(e) => e.id}
                                jsonData={{
...
export default QuantityMismatchFilter
